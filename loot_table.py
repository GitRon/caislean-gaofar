...
def create_common_weapon(name: str, attack_bonus: int) -> Item:
    ...
    return Item(name, ItemType.WEAPON, f"Deals {attack_bonus} extra damage", attack_bonus=attack_bonus)


def create_common_armor(name: str, defense_bonus: int, health_bonus: int = 0) -> Item:
    """Create a common armor item."""
    return Item(name, ItemType.ARMOR, f"+{defense_bonus} defense", defense_bonus=defense_bonus, health_bonus=health_bonus)


def create_consumable(name: str, health_bonus: int) -> Item:
    """Create a consumable item."""
    return Item(name, ItemType.CONSUMABLE, f"Restores {health_bonus} health", health_bonus=health_bonus)
...
LOOT_TABLES = {
    'banshee': LootTable([
        (create_common_armor("Spectral Veil", defense_bonus=8, health_bonus=15), 0.3),
    ...
    'pooka': LootTable([
        ...
        (create_common_armor("Shadow Pelt", defense_bonus=10, health_bonus=20), 0.3),
        (create_consumable("Dark Berry", health_bonus=30), 0.5),
    ]),

    'selkie': LootTable([
        (create_common_armor("Seal Skin Cloak", defense_bonus=12, health_bonus=25), 0.4),
    ...
    'dullahan': LootTable([
        ...
        (create_common_armor("Dark Rider's Mail", defense_bonus=15, health_bonus=30), 0.3),
    ...
    'merrow': LootTable([
        (create_common_armor("Coral Crown", defense_bonus=11, health_bonus=22), 0.35),
    ...
    'fear_gorta': LootTable([
        ...
        (create_common_armor("Tattered Robes", defense_bonus=6, health_bonus=10), 0.4),
