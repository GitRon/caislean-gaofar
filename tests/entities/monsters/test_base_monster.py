...
class TestBaseMonster:
    ...
    @patch("caislean_gaofar.entities.monsters.base_monster.MONSTER_RENDERERS", {})
    ...
    @patch("caislean_gaofar.entities.monsters.base_monster.MONSTER_RENDERERS", {"test_monster": Mock()})
    def test_draw_with_custom_renderer(self):
        ...
        with patch.dict(
            "caislean_gaofar.entities.monsters.base_monster.MONSTER_RENDERERS", {"test_monster": mock_renderer}
        ):
            # Act
            monster.draw(screen)
